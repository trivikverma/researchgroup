...
1. [Lecture 1: Introduction to _Urban_ Data Science](#lecture-1---introduction-to-urban-data-science) (Sep 2 and 4, 2020)
2. [Lecture 2: Spatial and Urban Data](#lecture-2---spatial-and-urban-data) (Sep 9, 2020)
3. [Lecture 3: Data Grammar](#lecture-3---data-grammar) (Sep 11, 2020)
4. [Lecture 4: Data Engineering](#lecture-4---data-engineering) (Sep 18, 2020)
5. [Lecture 5 EDA and Visualisation:](#lecture-5---eda-and-visualisation) (Sep 23, 2020)
6. [Lecture 6: Geo-Visualisation](#lecture-6---geo-visualisation) (Sep 25, 2020)
7. [Lecture 7: Networks and Spatial Weights](#lecture-7---networks-and-spatial-weights) (Sep 30, 2020)
8. [Lecture 8: Exploratory Spatial Data Analysis](#lecture-8---exploratory-spatial-data-analysis) (Oct 2, 2020)
9. [Lecture 9: Machine Learning for Everyone](#lecture-9---machine-learning-for-everyone) (Oct 7, 2020)
10. [Lecture 10: Anatomy of a Learning Algorithm](#lecture-10---anatomy-of-a-learning-algorithm) (Oct 9, 2020)
11. [Lecture 11: Clustering](#lecture-11---clustering) (Oct 14, 2020)
12. [Lecture 12: Dimensionality Reduction](#lecture-12---dimensionality-reduction) (Oct 16, 2020)
...
### Slides (Note:these will be updated on class days)
...
[A Visual Introduction to Machine Learning by r2d3](http://www.r2d3.us/visual-intro-to-machine-learning-part-1/). It is a beautiful two-part series.
...
* Go through this fantastic medium post about [A first step toward the future of neighbourhood design](https://medium.com/sidewalk-talk/a-first-step-toward-the-future-of-neighborhood-design-a2777ad69550)
